...
```txt
Usage: nirmalatai-ui init [options]
...
```bash
npx nirmalatai-ui@latest add [component]
```
...
```txt
Usage: nirmalatai-ui add [options] [components...]
...
```txt
Usage: nirmalatai-ui diff [options] [component]
