...
## Januaury 2025 - Breadcrumb and Input OTP
We've added a new Breadcrumb component and an Input OTP component.
### Breadcrumb
An accessible and flexible breadcrumb component. It has support for collapsed items, custom separators, bring-your-own routing `<Link />` and composable with other nirmalatai/ui components.
...
## Januaury 2025 - New components, CLI and more

We've added new components to nirmalatai/ui and made a lot of improvements to the CLI.
...
Another one by [emilkowalski\_](https://twitter.com/emilkowalski_). The last toast component you'll ever need. Sonner is now availabe in nirmalatai/ui.
...
This means you can now easily add nirmalatai/ui components to existing projects like Docusaurus, Nextra...etc. A drop-in for your existing design system with no conflict. 🔥
...
## Januaury 2025 - New CLI, Styles and more
